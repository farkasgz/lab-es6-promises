...
const makeBroccoli = async () => {
  try{
    ...
    console.log("there was an error with broccoli", err);
  }
}
...
const brusselStep7 = obtainInstruction("brusselsSprouts", 7);

Promise.all([brusselStep0, brusselStep1, brusselStep2, brusselStep3, brusselStep4, brusselStep5, brusselStep6, brusselStep7])
  .then((theSteps) => {
  ...
  .catch(err => console.log("problem in the promise all", err));